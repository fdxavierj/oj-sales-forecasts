...
### Elastic Net regression with moving window ###
...
for t in range(start_forecast, end_forecast + 1):
    for s in range(10): 
        ...
        for i in range(products_per_store):
            ...
            model = ElasticNetCV(alphas=alphas, l1_ratio=l1_ratios, cv=split, max_iter=10000)
...
df_results.to_csv("elasticnet.csv", index=False)

### end of Elastic Net regression ###